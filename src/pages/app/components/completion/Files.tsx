...
export const Files = ({
  ...
  const acceptedTypes =
    "image/*,.pdf,.doc,.docx,.txt,application/pdf,text/plain,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document";
                ...
                {attachedFiles.map((file) => (
                  ...
                  >
                    {file.type.startsWith("image/") ? (
                      ...
                      <div className="w-full h-full min-h-24 flex items-center justify-center bg-muted/50">
