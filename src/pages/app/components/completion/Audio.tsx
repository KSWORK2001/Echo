...
export const Audio = ({
  ...
  const speechProviderConfigured = Boolean(selectedSttProvider.provider);

  return (
    <Popover open={micOpen} onOpenChange={setMicOpen}>
      <PopoverTrigger asChild>
        {speechProviderConfigured && enableVAD ? (
          <AutoSpeechVAD
      ...
      <PopoverContent
        align="end"
        side="bottom"
        className={`w-80 p-3 ${speechProviderConfigured ? "hidden" : ""}`}
        sideOffset={8}
      >
