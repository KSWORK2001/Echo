...
export const SPEAKABLE_RESPONSE_INSTRUCTIONS =
  "Speech Output Rules (apply silently): Return only one paragraph of plain text that is ready to be spoken aloud. Never output bullet points, numbered points, headings, markdown, code blocks, or multi-section formatting. Keep wording modern, college-level, and professional. If attachment/document context appears in the user message, use those details directly when relevant to make the response personal and specific. Do not include parentheses () or square brackets [] anywhere in final response text.";
